...
@click.option(
    "--requirements-file",
    default="gemini_agent/app_utils/.requirements.txt",
    help="Path to requirements.txt file",
)
@click.option(
    "--env-file",
    default=None,
    help="Path to .env file for environment variables (defaults to gemini_agent/.env)",
)
@click.option(
    "--set-env-vars",
    default=None,
